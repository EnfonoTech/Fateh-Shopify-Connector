...
from fateh_shopify_connector.fateh_shopify_connector._inventory_test_fixtures import (
	TEST_COMPANY,
	TEST_WAREHOUSE,
...
class TestSyncStoreInventory(FrappeTestCase):
	...
	def setUp(self):
		# Clear Fateh Shopify Log rows from prior tests so status
		# assertions in this run can't be satisfied by stale logs.
		frappe.db.delete("Fateh Shopify Log", {"shopify_store": self.store.name})
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.Session")
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.set_inventory_batch")
	def test_happy_path_sends_both_items(self, mock_set, mock_session):
		...
		from fateh_shopify_connector.fateh_shopify_connector.inventory import sync_store_inventory
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.Session")
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.fetch_inventory_item_ids")
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.set_inventory_batch")
	...
	def test_bench_config_bailout_skips_store(self, mock_set, mock_session):
		...
		conf_override["fateh_shopify_connector_disable_graphql_inventory_sync"] = [self.store.name]
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.time.sleep")
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.Session")
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.set_inventory_batch")
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.frappe.enqueue")
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.frappe.get_all")
	def test_scheduler_keeps_full_inventory_mode_on_full_sync_method(self, mock_get_all, mock_enqueue):
		...
		from fateh_shopify_connector.fateh_shopify_connector.inventory import (
	...
	def test_changed_bin_sync_sends_only_mapped_bin_changes(self, mock_set, mock_session):
		...
		from fateh_shopify_connector.fateh_shopify_connector.inventory import sync_changed_bin_inventory
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.sync_store_inventory")
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.frappe.msgprint")
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory.frappe.enqueue")
...
class TestExecuteBatchWithRetry(FrappeTestCase):
	...
	def test_429_retries_with_retry_after_sleep(self, mock_set, mock_sleep):
		...
		from fateh_shopify_connector.fateh_shopify_connector.inventory import _execute_batch_with_retry
...
class TestSyncSingleItemInventory(FrappeTestCase):
	...
	def test_single_item_happy_path(self, mock_set, mock_session):
		...
		from fateh_shopify_connector.fateh_shopify_connector.inventory import sync_single_item_inventory
