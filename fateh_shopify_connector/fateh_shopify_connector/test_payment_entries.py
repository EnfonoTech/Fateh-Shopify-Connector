...
from fateh_shopify_connector.fateh_shopify_connector._payment_test_fixtures import (
	TEST_GATEWAY_CARD,
...
from fateh_shopify_connector.fateh_shopify_connector.order import (
...
class TestFetchOrderTransactions(FrappeTestCase):
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.order.Session")
...
class TestCreatePaymentEntriesOrchestrator(FrappeTestCase):
	...
	def tearDownClass(cls):
		...
		frappe.db.delete("Fateh Shopify Log", {"shopify_store": cls.store.name})
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.order._fetch_order_transactions")
	...
	@patch("fateh_shopify_connector.fateh_shopify_connector.order.create_shopify_log")
	@patch("fateh_shopify_connector.fateh_shopify_connector.order._fetch_order_transactions")
