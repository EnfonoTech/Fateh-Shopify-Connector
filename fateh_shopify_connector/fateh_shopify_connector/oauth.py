...
from fateh_shopify_connector.fateh_shopify_connector.connection import normalize_shop_domain
...
def get_callback_url() -> str:
	...
	return f"{site_url}/api/method/fateh_shopify_connector.fateh_shopify_connector.oauth.callback"
