...
Run tests with:
    bench --site <site> run-tests --app fateh_shopify_connector --module fateh_shopify_connector.fateh_shopify_connector.tax.test_tax

Or run specific test class:
    bench --site <site> run-tests --app fateh_shopify_connector --module fateh_shopify_connector.fateh_shopify_connector.tax.test_tax --test TestTaxDetector
"""
...
from fateh_shopify_connector.fateh_shopify_connector.tax.fixtures import (
	create_test_items,
