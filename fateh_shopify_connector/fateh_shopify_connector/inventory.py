...
INVENTORY_SYNC_METHOD_FULL = "fateh_shopify_connector.fateh_shopify_connector.inventory.sync_store_inventory"
INVENTORY_SYNC_METHOD_CHANGED_BINS = (
	"fateh_shopify_connector.fateh_shopify_connector.inventory.sync_changed_bin_inventory"
)
...
def sync_store_inventory(store_name: str, force: bool = False):
	...
	skip_stores = frappe.conf.get("fateh_shopify_connector_disable_graphql_inventory_sync") or []
...
def manual_inventory_sync(store_name: str):
	...
	frappe.enqueue(
		"fateh_shopify_connector.fateh_shopify_connector.inventory.sync_store_inventory",
		queue="long",
		timeout=10800,
		job_id=f"inventory_sync_{store_name}",
		deduplicate=True,
