...
class TestSetInventoryBatch(FrappeTestCase):
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory_graphql.execute_graphql")
...
class TestExecuteGraphql(FrappeTestCase):
	@patch("fateh_shopify_connector.fateh_shopify_connector.inventory_graphql.shopify")
